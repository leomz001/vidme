...
function makeRequest(page) {
        ...
        request.execute(function(response)  {
            ...
            $.each(srchItems, function(index, item) {
                ...
                $('#results').append('<div class="videos"><h2 class="title">'+vidTitle + '</h2> <h4 class="descript">'+'<span style = "color:red;">Description:</span> <br/> '+vidDescription +'</h4> <div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/'+vidId +'"</iframe></div></div></div>');
